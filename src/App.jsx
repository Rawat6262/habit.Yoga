      ...
      <div className="max-w-md w-full mx-auto text-center p-6">
        ...
        <div className="flex flex-col gap-3 mt-4">
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black placeholder-gray-600 placeholder:text-lg"
          />
          ...
          <div className="flex gap-2 w-full">
            ...
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black placeholder-gray-500"
            />
          </div>

          <button className="w-full bg-[linear-gradient(to_right,_rgb(158,76,0),_rgb(206,92,0))] text-white font-bold py-3 rounded-3xl mt-2 text-[20px]">
